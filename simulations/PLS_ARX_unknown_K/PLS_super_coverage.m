...
title1 = [ 'PLS_ARX_cover_N_', num2str(N), '_T_', num2str(T), '_Rep_', num2str(Rep),'_seed_', num2str(seed)];
load( [title1,'.mat'] );
...
title2 = [ 'PLS_ARX_oracle2_N_', num2str(N), '_T_', num2str(T), '_Rep_', num2str(Rep),'_seed_', num2str(seed)];
save( [title2, '.mat']);
